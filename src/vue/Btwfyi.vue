<template>
  <Teleport to="body">
    ...
    <Teleport v-if="toast" to="body">
      <div
        :class="[
          'fixed top-4 right-4 z-[10001] px-4 py-3 rounded-lg border shadow-xl font-mono text-sm transition-all btwfyi-toast',
          toast.type === 'success'
...
import type { CategoryConfig, Connection, DisplayMode, Pos, TodoStatus, UndoSnapshot } from '../core/types'
