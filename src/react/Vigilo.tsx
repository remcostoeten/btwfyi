...
function VigiloCore<TCategories extends readonly CategoryConfig[] = CategoryConfig[]>({
  ...
  function performUndo() {
    ...
    saveDisplayMode(keys, snapshot.displayMode)
    saveHidden(keys, snapshot.isHidden)
      ...
      reader.onload = (e) => {
        try {
          ...
          if (config.connections) {
            ...
            saveConnections(keys, config.connections)
          }
          if (config.statuses) {
